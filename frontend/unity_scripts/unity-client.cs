...
public class WebsocketClient : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        ws.OnMessage += (sender, e) =>
        {
            ...
            Debug.Log("MoveData: type=" + moveData.type + ", x=" + moveData.x + ", y=" + moveData.y + ", direction=" + moveData.direction + ", distance=" + moveData.distance + ", xRotate=" + moveData.xRotate + ", yRotate=" + moveData.yRotate + ", distanceRotate=" + moveData.distanceRotate);
